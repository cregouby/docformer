...
[![R-CMD-check](https://github.com/cregouby/docformer/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/cregouby/docformer/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
Predict with the headless model gives a document-layout embedding tensor of shape [ <document pages>, <max_position_embeddings>, <hidden_size> ]
