...
# docformer_model <- docformer_pretrain(doc_tensor, epochs=30)

```

### Train the model (work in progress)
followed by a supervised raining task on annotated documents
```{r}
# docformer_model <- docformer_fit(doc_tensor, from_model=docformer_model, epochs=30)
```
